...
<div class="news_content">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse;font-size:14"  class="newsline">  
      <tr>
		 <td width='11%' height=44>游记编号：</td><td width='39%'>${youjixinxi.youjibianhao}</td><td  rowspan=6 align=center><a href=${youjixinxi.fengmiantupian} target=_blank><img src=${youjixinxi.fengmiantupian}  width=228 height=215 border=0></a></td></tr><tr>
         <td width='11%' height=44>游记标题：</td><td width='39%'>${youjixinxi.youjibiaoti}</td></tr><tr>
         
         <td width='11%' height=44>行程时间：</td><td width='39%'>${youjixinxi.xingchengshijian}</td></tr><tr>
         <td width='11%' height=44>主要景点：</td><td width='39%'>${youjixinxi.zhuyaojingdian}</td></tr><tr>
         <td width='11%' height=44>行程路线：</td><td width='39%'>${youjixinxi.xingchengluxian}</td></tr><tr>
         
         <td width='11%' height=44>发布人：</td><td width='39%'>${youjixinxi.faburen}</td></tr><tr>
         <td width='11%' height=100  >内容详情：</td><td width='39%' colspan=2 height=100 >${youjixinxi.neirongxiangqing}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse;font-size:14" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("youjixinxi",id)){
	pli=pli+1;
     %>
                                   <tr>
...
<input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('youjixinxi','<%=id%>')"/>
<input type=button name=Submit52 value=收藏 onClick="javascript:location.href='jrsc.jsp?id=<%=id%>&biao=youjixinxi&biaoj=yjxx&ziduan=youjibiaoti';" />
</td></tr>
