...
<div class="intitle">
	<ul>
    	<li><h1>系统简介/</h1><span>About us</span></li>
    </ul>
</div>
<div class="box gsjj">
	<div class="gsjj-left">
    ...
    <div class="gsjj-right">
        ...
        <%=connDbBean.readzd("dx","content","leibie","系统简介")%>
...
公司行为准则:忠信仁义，以人为本。 
    ...
    <span><a href="dx_detail.php?lb=系统简介">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span></p>
...
<div class="intitle">
	<ul>
    	<li><h1>推荐景点/</h1><span>New Products</span></li>
    </ul>
</div>
<div class="box p-list">
	<a href="#" class="more-products">了解更多博主信息>></a>
    <ul>
        <c:forEach items="${syjingdianxinxi1 }" var="a">
    	<li><a href="jdxxDetail.do?id=${a.id}"><img src="${a.jingdianzhutu}" width="299" height="304"/><span>${a.jingdianmingcheng}</span></a></li>
        </c:forEach>
	...
	<div class="box contact-content">
      <div class="liuyan">
      	<div class="news-list-title2">
        	<h2>旅游攻略/<span>News</span></h2>
            <a href="news.php?lb=旅游攻略"></a>
        </div>
        <div class="n-lists2">
        	<ul>
