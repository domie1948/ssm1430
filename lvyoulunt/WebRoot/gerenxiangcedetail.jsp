...
<div class="news_content">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse;font-size:14"  class="newsline">  
      <tr>
		 <td width='11%' height=44>编号：</td><td width='39%'>${gerenxiangce.bianhao}</td><td  rowspan=4 align=center><a href=${gerenxiangce.fengmian} target=_blank><img src=${gerenxiangce.fengmian}  width=228 height=215 border=0></a></td></tr><tr>
         <td width='11%' height=44>名称：</td><td width='39%'>${gerenxiangce.mingcheng}</td></tr><tr>
         
         <td width='11%' height=44>主题：</td><td width='39%'>${gerenxiangce.zhuti}</td></tr><tr>
         
         <td width='11%' height=44>用户名：</td><td width='39%'>${gerenxiangce.yonghuming}</td></tr><tr>
         <td width='11%' height=100  >相片：</td><td width='39%' colspan=2 height=100 >${gerenxiangce.xiangpian}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse;font-size:14" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("gerenxiangce",id)){
	pli=pli+1;
     %>
                                   <tr>
...
<input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('gerenxiangce','<%=id%>')"/>
</td></tr>
