...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateZhanneisixin.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改站内私信<input type="hidden" name="id" value="${zhanneisixin.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.shoujianren.value='${zhanneisixin.shoujianren}';</script>	<script language="javascript">document.form1.biaoti.value='${zhanneisixin.biaoti}';</script>	<script language="javascript">document.form1.neirong.value='${zhanneisixin.neirong}';</script>	<script language="javascript">document.form1.fajianren.value='${zhanneisixin.fajianren}';</script>	<script language="javascript">document.form1.quanxian.value='${zhanneisixin.quanxian}';</script>	
					 </table>
			</form>
   </body>
</html>
