...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateGerenxiangce.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改个人相册<input type="hidden" name="id" value="${gerenxiangce.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${gerenxiangce.bianhao}';</script>	<script language="javascript">document.form1.mingcheng.value='${gerenxiangce.mingcheng}';</script>	<script language="javascript">document.form1.fengmian.value='${gerenxiangce.fengmian}';</script>	<script language="javascript">document.form1.zhuti.value='${gerenxiangce.zhuti}';</script>	<script language="javascript">document.form1.xiangpian.value='${gerenxiangce.xiangpian}';</script>	<script language="javascript">document.form1.yonghuming.value='${gerenxiangce.yonghuming}';</script>	
					 </table>
			</form>
   </body>
</html>
